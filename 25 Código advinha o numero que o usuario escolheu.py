# Desta vez, vamos fazer exatamente o oposto. Você, o usuário, terá na cabeça um número entre 0 e 100. O programa
# adivinhará um número e você, o usuário, dirá se é muito alto, muito baixo ou o seu número.
...
#         m = (i + j) / 2
#         condition = input(
#             "Is your guess " + str(m) + "? (0 means it's too low, 1 means it's your guess and 2 means it's too high) ")
