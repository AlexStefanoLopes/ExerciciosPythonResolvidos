# Como você deve ter adivinhado, estamos tentando construir um tabuleiro de jogo da velha completo. No entanto,
# isso é significativamente mais do que meia hora de codificação, então estamos fazendo isso em pedaços. Hoje,
# vamos simplesmente nos concentrar em verificar se alguém GANHOU um jogo de Tic Tac Toe, sem nos preocupar com como
# os movimentos foram feitos.
